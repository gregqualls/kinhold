...
export const REGISTRY = [
  ...
  { slug: 'segmented-filter', tier: 'compounds', title: '4.2 SegmentedFilter', description: 'Filled active inside an outlined container, with ease-out fill transition on selection.', pagePath: './pages/compounds/SegmentedFilterPage.vue', scaffolded: true, chosen: false },
  ...
  { slug: 'action-pair', tier: 'compounds', title: '4.4 ActionPair', description: 'Equal-width [outline] [filled] is the primary pattern. Asymmetric [ghost] [filled] available as a variant for confident hierarchies.', pagePath: './pages/compounds/ActionPairPage.vue', scaffolded: true, chosen: false },

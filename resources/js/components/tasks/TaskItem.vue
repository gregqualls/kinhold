  ...
  >
    ...
    <div class="flex-1 min-w-0">
      ...
      <div class="flex items-center gap-3 mt-1 flex-wrap">
        ...
        <!-- Assignee -->
        <span v-if="task.assigned_to" class="flex items-center gap-1 text-xs text-lavender-500 dark:text-lavender-400">
...
import { CalendarIcon, DocumentTextIcon, PencilIcon, TrashIcon } from '@heroicons/vue/24/outline'

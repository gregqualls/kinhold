  ...
  <div class="flex flex-col h-full">
    <div class="flex items-center justify-between mb-3 flex-shrink-0">
      <h3 class="text-sm font-semibold text-prussian-500 dark:text-lavender-200 flex items-center gap-2">
        <UserGroupIcon class="w-4 h-4 text-sand-500" />
    ...
    <div v-else-if="tasks.length === 0" class="flex-1 flex items-center justify-center">
      <div class="text-center">
        <UserGroupIcon class="w-8 h-8 text-lavender-400 dark:text-lavender-500 mx-auto mb-1" />
        <p class="text-sm text-lavender-500 dark:text-lavender-400">No open family tasks</p>
      </div>
    </div>

...
class FamilyInviteNotification extends Notification implements ShouldQueue
{
    ...
    public function toMail(object $notifiable): MailMessage
    {
        ...
        return (new MailMessage)
            ->subject("You're invited to join {$this->family->name} on Q32 Hub")
            ->greeting("Hello!")
            ->line("{$this->inviterName} has invited you to join the **{$this->family->name}** family on Q32 Hub.")
            ->line("Q32 Hub is a family hub for managing calendars, tasks, important documents, and more — all in one place.")

...
<template>
  <ComponentPage
    ...
    description="Flagship detail-page treatment — edge-to-edge hero photo with frosted circular back/action buttons floating over it, and a content sheet that slides up from below. Used for recipe detail, restaurant detail, and any image-led detail view."
    status="scaffolded"
  >

    <!-- ═══════════════════════════════════════════════════════════════
         VARIANT A — Full-bleed photo + overlapping content sheet
         Sheet slides UP ~24px into the photo; Apple Maps / Music pattern.
         ════════════════════════════════════════════════════════════════ -->
    <section class="mb-20">
      <VariantFrame
        label="A"
        caption="Full-bleed photo, content sheet overlaps bottom of photo by 24px. Classic iOS detail-page pattern."
      >
        <div class="w-full space-y-10">
          ...
          <div class="rounded-2xl border p-6 space-y-6" :style="{ background: L.surfaceApp, borderColor: L.borderSubtle }">
            ...
            <div class="flex justify-center">
              ...
              <div
                style="
                  width: 375px; border-radius: 40px; overflow: hidden;
              ...
              >
                ...
                <div
                  ...
                  "
                >
                  <!-- Gradient scrim at bottom of photo so sheet corners read clearly -->
                  <div
                    style="
                      position: absolute; bottom: 0; left: 0; right: 0; height: 60px;
                      background: linear-gradient(to top, rgba(250,248,245,0.40), transparent);
                    "
                  />

                  <!-- Frosted back button — top left -->
                  <div style="position: absolute; top: 52px; left: 20px; display: flex; gap: 10px;">
                    <div :style="frostBtnLight">
                      <ArrowLeftIcon style="width: 18px; height: 18px; color: #1C1C1E;" />
                    </div>
                  </div>

                  <!-- Frosted share + bookmark — top right -->
                  <div style="position: absolute; top: 52px; right: 20px; display: flex; gap: 10px;">
                    <div :style="frostBtnLight">
                      <ShareIcon style="width: 18px; height: 18px; color: #1C1C1E;" />
                    </div>
                    <div :style="frostBtnLight">
                      <BookmarkIcon style="width: 18px; height: 18px; color: #1C1C1E;" />
                    </div>
                  </div>
                </div>

                <!-- Content sheet — bottom 45% + 24px overlap (negative top) -->
                <div
                  :style="{
                    position: 'absolute',
                    top: 'calc(57% - 24px)',
                ...
                >
                  <!-- Grab handle -->
                  <div style="display: flex; justify-content: center; padding-top: 10px; padding-bottom: 6px; flex-shrink: 0;">
                    <div style="width: 36px; height: 4px; border-radius: 99px; background: #9C9895;" />
                  </div>

                  <!-- Content -->
                  <div style="padding: 12px 20px 20px; flex: 1; display: flex; flex-direction: column; gap: 12px; overflow: hidden;">
                    <!-- Title -->
                    <h2
                      style="font-family: 'Plus Jakarta Sans', sans-serif; font-size: 22px; font-weight: 700; line-height: 1.2; letter-spacing: -0.02em; margin: 0;"
                    ...
                    <div style="display: flex; align-items: center; gap: 14px;">
                      <div style="display: flex; align-items: center; gap: 5px;">
                        <ClockIcon style="width: 14px; height: 14px; flex-shrink: 0;" :style="{ color: L.inkTertiary }" />
                        <span style="font-size: 12px; font-weight: 500;" :style="{ color: L.inkSecondary }">2h 30m</span>
                      </div>
                      <div style="display: flex; align-items: center; gap: 5px;">
                        <FireIcon style="width: 14px; height: 14px; flex-shrink: 0;" :style="{ color: L.inkTertiary }" />
                        <span style="font-size: 12px; font-weight: 500;" :style="{ color: L.inkSecondary }">Medium</span>
                      </div>
                      <div style="display: flex; align-items: center; gap: 5px;">
                        <ChartBarIcon style="width: 14px; height: 14px; flex-shrink: 0;" :style="{ color: L.inkTertiary }" />
                        <span style="font-size: 12px; font-weight: 500;" :style="{ color: L.inkSecondary }">620 kcal</span>
                      </div>
                    </div>

                    <!-- Author strip -->
                    <div style="display: flex; align-items: center; gap: 10px; padding: 10px 12px; border-radius: 14px;" :style="{ background: L.surfaceSunken }">
                      <div
                        style="width: 32px; height: 32px; border-radius: 50%; flex-shrink: 0; display: flex; align-items: center; justify-content: center; font-size: 13px; font-weight: 700;"
                        :style="{ background: L.accents.peach.soft, color: L.accents.peach.bold }"
                      >G</div>
                      <div style="flex: 1; min-width: 0;">
                        <p style="font-size: 12px; font-weight: 600; margin: 0;" :style="{ color: L.inkPrimary }">Grandma Qualls</p>
                        <p style="font-size: 11px; margin: 0;" :style="{ color: L.inkTertiary }">Family recipe · 4 generations</p>
                      </div>
                    </div>
              ...
              >
                ...
                >
                  <div
                    style="
                      position: absolute; bottom: 0; left: 0; right: 0; height: 60px;
                      background: linear-gradient(to top, rgba(28,27,25,0.50), transparent);
                    "
                  />
                  <div style="position: absolute; top: 52px; left: 20px;">
                    <div :style="frostBtnDark">
                      <ArrowLeftIcon style="width: 18px; height: 18px; color: #F0EDE9;" />
                    </div>
                  </div>
                  <div style="position: absolute; top: 52px; right: 20px; display: flex; gap: 10px;">
                    <div :style="frostBtnDark">
                      <ShareIcon style="width: 18px; height: 18px; color: #F0EDE9;" />
                    </div>
                    <div :style="frostBtnDark">
                      <BookmarkIcon style="width: 18px; height: 18px; color: #F0EDE9;" />
                    </div>
                  </div>
                </div>
                ...
                >
                  <div style="display: flex; justify-content: center; padding-top: 10px; padding-bottom: 6px; flex-shrink: 0;">
                    <div style="width: 36px; height: 4px; border-radius: 99px; background: #6E6B67;" />
                  </div>
                  <div style="padding: 12px 20px 20px; flex: 1; display: flex; flex-direction: column; gap: 12px; overflow: hidden;">
                    <h2
                      style="font-family: 'Plus Jakarta Sans', sans-serif; font-size: 22px; font-weight: 700; line-height: 1.2; letter-spacing: -0.02em; margin: 0;"
                    ...
                    <div style="display: flex; align-items: center; gap: 14px;">
                      <div style="display: flex; align-items: center; gap: 5px;">
                        <ClockIcon style="width: 14px; height: 14px;" :style="{ color: D.inkTertiary }" />
                        <span style="font-size: 12px; font-weight: 500;" :style="{ color: D.inkSecondary }">2h 30m</span>
                      </div>
                      <div style="display: flex; align-items: center; gap: 5px;">
                        <FireIcon style="width: 14px; height: 14px;" :style="{ color: D.inkTertiary }" />
                        <span style="font-size: 12px; font-weight: 500;" :style="{ color: D.inkSecondary }">Medium</span>
                      </div>
                      <div style="display: flex; align-items: center; gap: 5px;">
                        <ChartBarIcon style="width: 14px; height: 14px;" :style="{ color: D.inkTertiary }" />
                        <span style="font-size: 12px; font-weight: 500;" :style="{ color: D.inkSecondary }">620 kcal</span>
                      </div>
                    </div>
                    <div style="display: flex; align-items: center; gap: 10px; padding: 10px 12px; border-radius: 14px;" :style="{ background: D.surfaceSunken }">
                      <div
                        style="width: 32px; height: 32px; border-radius: 50%; flex-shrink: 0; display: flex; align-items: center; justify-content: center; font-size: 13px; font-weight: 700;"
                        :style="{ background: D.accents.peach.soft, color: D.accents.peach.bold }"
                      >G</div>
                      <div style="flex: 1; min-width: 0;">
                        <p style="font-size: 12px; font-weight: 600; margin: 0;" :style="{ color: D.inkPrimary }">Grandma Qualls</p>
                        <p style="font-size: 11px; margin: 0;" :style="{ color: D.inkTertiary }">Family recipe · 4 generations</p>
                      </div>
                    </div>
                    <div style="flex: 1;" />
                    <button
                      style="width: 100%; padding: 14px; border-radius: 99px; border: none; font-size: 15px; font-weight: 600; cursor: pointer; letter-spacing: -0.01em;"
    ...
    <!-- ═══════════════════════════════════════════════════════════════
         VARIANT B — 60/40 split, no overlap, clean horizontal divide
         ════════════════════════════════════════════════════════════════ -->
    <section class="mb-20">
      <VariantFrame
        label="B"
        caption="60/40 split — photo top 60%, content sheet flush beneath. No overlap. Cleaner for content-heavy detail pages."
      >
        <div class="w-full space-y-10">
            ...
            <div class="flex justify-center">
              ...
              >
                ...
                >
                  ...
                  <!-- Clean badge — recipe tag bottom-left -->
                  <div
                    style="position: absolute; bottom: 14px; left: 16px; padding: 4px 10px; border-radius: 99px; font-size: 11px; font-weight: 600; backdrop-filter: blur(8px); -webkit-backdrop-filter: blur(8px);"
                    :style="{ background: 'rgba(255,255,255,0.80)', color: L.accents.mint.bold }"
                  >Sunday Dinner</div>
                </div>

                <!-- Content sheet: 40% — flush, no rounding on top (already clipped by frame) -->
                <div
                  :style="{
                    flex: '0 0 40%',
                    background: L.surfaceRaised,
                ...
                >
                  <div style="padding: 16px 20px 20px; flex: 1; display: flex; flex-direction: column; gap: 10px; overflow: hidden;">
                    <h2
                      style="font-family: 'Plus Jakarta Sans', sans-serif; font-size: 20px; font-weight: 700; line-height: 1.25; letter-spacing: -0.02em; margin: 0;"
                      :style="{ color: L.inkPrimary }"
                    >Grandma's Sunday Roast</h2>
                    ...
                    <div style="display: flex; align-items: center; gap: 12px;">
                      <div style="display: flex; align-items: center; gap: 5px;">
                        <ClockIcon style="width: 13px; height: 13px;" :style="{ color: L.inkTertiary }" />
                        <span style="font-size: 11px; font-weight: 500;" :style="{ color: L.inkSecondary }">2h 30m</span>
                      </div>
                      <div style="display: flex; align-items: center; gap: 5px;">
                        <FireIcon style="width: 13px; height: 13px;" :style="{ color: L.inkTertiary }" />
                        <span style="font-size: 11px; font-weight: 500;" :style="{ color: L.inkSecondary }">Medium</span>
                      </div>
                      <div style="display: flex; align-items: center; gap: 5px;">
                        <ChartBarIcon style="width: 13px; height: 13px;" :style="{ color: L.inkTertiary }" />
                        <span style="font-size: 11px; font-weight: 500;" :style="{ color: L.inkSecondary }">620 kcal</span>
                      </div>
                    </div>
                    ...
                    <div style="display: flex; align-items: center; gap: 8px;">
                      <div
                        ...
                        :style="{ background: L.accents.peach.soft, color: L.accents.peach.bold }"
                      >G</div>
                      <span style="font-size: 12px; font-weight: 500;" :style="{ color: L.inkSecondary }">Grandma Qualls</span>
                    </div>
                    ...
                    <!-- CTA -->
                    <button
                      style="width: 100%; padding: 13px; border-radius: 99px; border: none; font-size: 14px; font-weight: 600; cursor: pointer;"
                      :style="{ background: L.accents.peach.bold, color: '#FAF8F5' }"
                    >Start cooking</button>
                  </div>
                </div>
            ...
            <div class="flex justify-center">
              ...
              >
                ...
                >
                  ...
                  <div
                    style="position: absolute; bottom: 14px; left: 16px; padding: 4px 10px; border-radius: 99px; font-size: 11px; font-weight: 600; backdrop-filter: blur(8px); -webkit-backdrop-filter: blur(8px);"
                    :style="{ background: 'rgba(28,27,25,0.80)', color: D.accents.mint.bold }"
                  >Sunday Dinner</div>
                </div>
                ...
                >
                  <div style="padding: 16px 20px 20px; flex: 1; display: flex; flex-direction: column; gap: 10px; overflow: hidden;">
                    ...
                    <div style="display: flex; align-items: center; gap: 12px;">
                      <div style="display: flex; align-items: center; gap: 5px;">
                        <ClockIcon style="width: 13px; height: 13px;" :style="{ color: D.inkTertiary }" />
                        <span style="font-size: 11px; font-weight: 500;" :style="{ color: D.inkSecondary }">2h 30m</span>
                      </div>
                      <div style="display: flex; align-items: center; gap: 5px;">
                        <FireIcon style="width: 13px; height: 13px;" :style="{ color: D.inkTertiary }" />
                        <span style="font-size: 11px; font-weight: 500;" :style="{ color: D.inkSecondary }">Medium</span>
                      </div>
                      <div style="display: flex; align-items: center; gap: 5px;">
                        <ChartBarIcon style="width: 13px; height: 13px;" :style="{ color: D.inkTertiary }" />
                        <span style="font-size: 11px; font-weight: 500;" :style="{ color: D.inkSecondary }">620 kcal</span>
                      </div>
                    </div>
                    <div style="display: flex; align-items: center; gap: 8px;">
                      <div
                        ...
                        :style="{ background: D.accents.peach.soft, color: D.accents.peach.bold }"
                      >G</div>
                      <span style="font-size: 12px; font-weight: 500;" :style="{ color: D.inkSecondary }">Grandma Qualls</span>
                    </div>
                    <div style="flex: 1;" />
                    <button
                      style="width: 100%; padding: 13px; border-radius: 99px; border: none; font-size: 14px; font-weight: 600; cursor: pointer;"
    ...
    <section class="mb-20">
      <VariantFrame
        label="C"
        caption="Parallax scroll — photo scrolls at ~50% rate. Two static states shown side-by-side: initial (photo full) and scrolled (sheet covers photo). Most immersive, magazine-page feel."
      >
        <div class="w-full space-y-10">
      ...
      >
        ...
        <div>
          ...
          <p class="text-sm leading-relaxed" :style="{ color: L.inkPrimary }">
            Variant A is the strongest default for Kinhold's recipe and restaurant detail screens. The 24px sheet overlap into the photo gives the screen a single cohesive composition — the photo doesn't end, the content begins from within it — which is the exact sensory cue that makes iOS detail pages feel native and premium. Variant B is a sound fallback when the page carries dense content that would feel cramped in Variant A's shallower sheet. Variant C is reserved for flagship launch moments or immersive storytelling screens where the engineering investment in scroll-linked animation is worth the payoff.
          </p>
        </div>
      </div>
    </section>

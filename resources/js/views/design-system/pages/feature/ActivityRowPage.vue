...
<template>
  ...
  >
    ...
    <!-- ═══════════════════════════════════════════════════════════════
         ...
         ════════════════════════════════════════════════════════════════ -->
    <section class="mb-20">
      <VariantFrame label="ActivityRow" caption="Conversational — avatar-left, text + optional subtext, inline action buttons for kudos-style rows. The single locked ActivityRow — used in points activity feed, kudos feed, and social events.">

...
// Kin component preview — v-model state for the demo trigger
...
<template>
  ...
  >
    ...
    <!-- ══════════════════════════════════════════════════════════════════════
         ...
         ═══════════════════════════════════════════════════════════════════ -->
    <section class="mb-16">
      <VariantFrame label="Kin" caption="KinModalSheet — proposed extraction. Click the trigger to open. Responsive: bottom sheet on mobile, centered modal at md+.">
      ...
      <!-- The actual Kin overlay (Teleported to body). Tokens follow root theme. -->
      <KinModalSheet
